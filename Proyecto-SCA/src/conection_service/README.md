...
```
C:\Users\Lenovo P52s\Desktop\Proyecto-SCA\conection_service
```
...
```powershell
cd "C:\Users\Lenovo P52s\Desktop\Proyecto-SCA\conection_service"
...
3. Acción: **Iniciar un programa**.
   ...
   - Argumentos: `main.py`
   - Iniciar en: `C:\Users\Lenovo P52s\Desktop\Proyecto-SCA\conection_service`
