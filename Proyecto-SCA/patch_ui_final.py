...
'''
content = re.sub(r'</body>', modal_html + '\n</body>', content)

# 5. Add UI JS carefully, ONLY before the LAST </script> tag or append a new script tag
js_logic = '''
<script>
...
# append the script before the body closing tag
