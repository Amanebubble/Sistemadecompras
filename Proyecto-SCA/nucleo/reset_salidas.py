...
# 2. Eliminar archivos en carpetas de estado (no borrar la carpeta, solo contenido)
...
# IMPORTANTE: No tocar Descarga-doc/
print("Reset de salidas finalizado. Descarga-doc/ se mantuvo intacto.")
